...
const { convertCurrencyReal, getCodes, sumAccumulator, getLastOrFirstPositionYear, getOtherLastPosition, taxCal, getNode, convertCurrencyRealWithoutCoin } = require("./utils");
const { TYPE_OPERATIONS_SELL, LIMIT_SWING_TRADE, MONTHS_LABEL } = require("./vars");
...
function composeOperationsFII(operations, yearAnalysis, lossesSalesFii) {
   ...
   * @returns 
   */
  function composeOperations(operations, indexMonth, indexYear, op, SUM_SWING_TRADE_FREE_99) {    
